...
}`,...(Z=(M=R.parameters)==null?void 0:M.docs)==null?void 0:Z.source}}};var F,J,K;B.parameters={...B.parameters,docs:{...(F=B.parameters)==null?void 0:F.docs,source:{originalSource:`(args: ToggleBarProps<string>) => {
  const [value, setValue] = useState<string | undefined>();
...
}`,...(K=(J=B.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var Q,U,Y;y.parameters={...y.parameters,docs:{...(Q=y.parameters)==null?void 0:Q.docs,source:{originalSource:`(args: ToggleBarProps<string>) => {
  const [value, setValue] = useState<string | undefined>();
...
}`,...(Y=(U=y.parameters)==null?void 0:U.docs)==null?void 0:Y.source}}};var ee,le,ae;z.parameters={...z.parameters,docs:{...(ee=z.parameters)==null?void 0:ee.docs,source:{originalSource:`(args: ToggleBarProps<string>) => {
  const [value, setValue] = useState<string | undefined>();
...
//# sourceMappingURL=ToggleBar.stories-a330395e.js.map
