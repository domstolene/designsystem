import{a as e}from"./jsx-runtime-e43ccb36.js";import{C as s}from"./Caption-d810b87c.js";import{S as l}from"./StoryTemplate-73234f44.js";const c={title:"dds-components/Typography/Caption",component:s,argTypes:{withMargins:{control:{type:"boolean"}},text:{control:{type:"text"}}}},t=n=>{const{text:p,...i}=n;return e(l,{title:"Caption - default",children:e(s,{...i,children:p||"Caption"})})};var o,r,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: StoryTProps) => {
  const {
    text,
    ...rest
  } = args;
...
//# sourceMappingURL=Caption.stories-1a9f105b.js.map
