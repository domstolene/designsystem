import{d as b,s as g,A as y,a as D,j as h}from"./ddsReferenceTokens-647ce456.js";import{r as L}from"./index-ebeaab24.js";import{s as S,g as v}from"./BaseComponentProps-a100791d.js";import"./libraryAdd-4099b973.js";import{I as $}from"./Icon-e6324a43.js";const{spacing:r,colors:d}=b,x={appearance:{small:{color:d.DdsColorNeutralsGray7},bold:{color:d.DdsColorNeutralsGray9}},firstOfType:{marginTop:r.SizesDdsSpacingLocalX1}},E={base:{gap:r.SizesDdsSpacingLocalX025,color:d.DdsColorNeutralsGray9},lastChild:{marginBottom:r.SizesDdsSpacingLocalX1}},P={beforeNextTerm:{marginTop:r.SizesDdsSpacingLocalX2},rowDirection:{columnGap:r.SizesDdsSpacingLocalX2}},k={base:{margin:r.SizesDdsSpacingLocalX2}},p={term:x,desc:E,list:P,group:k},{term:_,desc:w,list:T}=p,H=g.dl`
  margin: 0;
  *::selection {
    ${S}
  }
...
//# sourceMappingURL=DescriptionListDesc-9319d6fe.js.map
