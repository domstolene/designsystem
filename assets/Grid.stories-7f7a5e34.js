import{d as M,b as le,s as a,A as y,j as e,a as o,F as ee}from"./focus-visible-c2e9b88d.js";import{S as ue,B as c}from"./LocalMessage.tokens-4f5ae050.js";import{h as ce,L as ie,T as d}from"./LocalMessage-856adaed.js";import{g as me,s as pe,f as ge,a as A,d as he,T as g}from"./Typography-52863865.js";import{_ as ye}from"./tslib.es6-b1ce3a18.js";import{S as p,u as ve}from"./useScreenSize-1c87db54.js";import"./index-ebeaab24.js";var m=M.colors,$=M.border,w=le.textDefault,Se={border:"".concat($.BordersDdsBorderStyleLightStrokeWeight," solid")},be={filledLight:{backgroundColor:m.DdsColorPrimaryLightest,borderColor:m.DdsColorPrimaryLightest,color:w.textColor},filledDark:{backgroundColor:m.DdsColorPrimaryBase,borderColor:m.DdsColorPrimaryBase,color:m.DdsColorNeutralsWhite},strokeDark:{backgroundColor:m.DdsColorNeutralsWhite,borderColor:$.BordersDdsBorderStyleLightStroke,color:w.textColor},strokeLight:{backgroundColor:m.DdsColorNeutralsWhite,borderColor:$.BordersDdsBorderStyleLightStroke,color:w.textColor}},v={base:Se,colors:be},P=a.div.withConfig({displayName:"Card__Container",componentId:"sc-410ao9-0"})(["border:",";",";&::selection,*::selection{","}@media (prefers-reduced-motion:no-preference){transition:box-shadow 0.2s,border-color 0.2s;}"," ",""],v.base.border,me(he),pe,function(r){var n=r.color;return n&&y(["color:",";background-color:",";border-color:",";"],v.colors[n].color,v.colors[n].backgroundColor,v.colors[n].borderColor)},function(r){var n=r.cardType;return n==="navigation"?y(["text-decoration:none;&:hover{","}&:focus{","}"],ce,ge):n==="expandable"?y(["width:100%;box-sizing:border-box;&:not(:first-of-type){border-top:none;}"]):""}),h=function(n){var k=n.color,T=k===void 0?"filledLight":k,D=n.cardType,x=n.cardRef,z=n.children,L=n.id,H=n.className,F=n.htmlProps,B=ye(n,["color","cardType","cardRef","children","id","className","htmlProps"]);if(D==="navigation"){var de=n.href,oe=n.target;return e(P,Object.assign({},A(L,H,F,B),{cardType:D,color:T,as:"a",ref:x,href:de,target:oe,children:z}))}return e(P,Object.assign({},A(L,H,F,B),{cardType:D,color:T,as:"div",ref:x,children:z}))};h.displayName="Card";function re(r){return e(ue,Object.assign({},r,{children:e("path",{d:"M19 12.998h-6v6h-2v-6H5v-2h6v-6h2v6h6v2z"})}))}const Ie={title:"Examples/Grid"},{breakpoints:t,grid:i,spacing:s}=M,fe=a.div`
  display: grid;
...
//# sourceMappingURL=Grid.stories-7f7a5e34.js.map
