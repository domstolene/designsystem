import{j as r,a as t,F as oe}from"./jsx-runtime-e43ccb36.js";import{S as w}from"./StoryTemplate-6a95b3b2.js";import"./Caption-956f7c23.js";import"./Heading-1a21ccc8.js";import"./Label-1e45d63d.js";import"./Legend-8f4b1074.js";import"./Link-1d242339.js";import"./Paragraph-6d49c218.js";import"./TextOverflowEllipsis-5f7b5b23.js";import{T as g}from"./Typography-aec60abc.js";import{d as S,s as C,n as Y,a as re}from"./ddsReferenceTokens-cf345c8b.js";import{o as ne,v as ie,b as le,e as ae,l as se,g as pe,P as de,f as ue}from"./BaseComponentProps-77dc9c6e.js";import{r as ce}from"./removeButtonStyling-867d6ba4.js";import{r as s}from"./index-1b03fe98.js";import{u as me}from"./useFloatPosition-8239dfed.js";import{C as ve}from"./libraryAdd-1d1f72ea.js";import"./Icon-764411b5.js";import{f as fe}from"./Input.styles-4ebb4961.js";import{B as p}from"./Button-ce4ef2c9.js";function ge(e,n,d){const i=s.useRef(null);return s.useEffect(()=>{function h(l){if(l.key!=="Tab"||!e||!i.current||!d)return;const c=ne(i),a=c[c.length-1],k=c[0];(!l.shiftKey&&document.activeElement===a||l.shiftKey&&document.activeElement===k||l.shiftKey&&document.activeElement===o)&&(d.focus(),l.preventDefault(),n())}const o=i.current;return o&&e&&(o.focus(),o.addEventListener("keydown",h)),()=>{o==null||o.removeEventListener("keydown",h)}},[e]),i}const{spacing:f}=S,he={padding:`${f.SizesDdsSpacingLocalX075} ${f.SizesDdsSpacingLocalX1} ${f.SizesDdsSpacingLocalX15} ${f.SizesDdsSpacingLocalX1}`},ke={top:f.SizesDdsSpacingLocalX025,right:f.SizesDdsSpacingLocalX025},ye={marginRight:f.SizesDdsSpacingLocalX2},Pe={noTitle:{marginTop:f.SizesDdsSpacingLocalX2}},xe={content:Pe,wrapper:he,closeButton:ke,title:ye},{spacing:Te}=S,{wrapper:Be,content:be,closeButton:M,title:Se}=xe,we=C(de)`
  opacity: 0;
...
//# sourceMappingURL=Popover.stories-7585d1a4.js.map
