...
`,j=r.forwardRef((e,l)=>{const{id:g,searchId:u,className:v,htmlProps:L,suggestions:a=[],showSuggestions:m,componentSize:X,onSuggestionClick:k,maxSuggestions:h,...x}=e,p=M(u,"suggestions-header"),[D,o]=ge(a&&a.length,!m),z=h?a==null?void 0:a.slice(h):a,I=i(He,{role:"listbox","aria-labelledby":p,children:z.map(($,S)=>i("li",{role:"option",children:i(Me,{index:S,focus:D===S&&m,setFocus:o,"aria-label":`søk på ${$}`,onClick:k,title:$,"aria-setsize":z.length,"aria-posinset":S,size:X})},S))}),y=!m;return w(Ve,{...ue(g,v,L,x),ref:l,isHidden:y,"aria-hidden":y,children:[i(Ae,{typographyType:"supportingStyleTiny01",forwardedAs:"span",id:p,children:"Søkeforslag"}),I]})});j.displayName="SearchSuggestions";function Oe(e){const l=document.getElementById(e);return l.value="",{target:l,currentTarget:l,bubbles:!0,cancelable:!1,defaultPrevented:!1,eventPhase:0,isTrusted:!1,preventDefault:()=>{},stopPropagation:()=>{},nativeEvent:new Event("input"),persist:()=>{},type:"change",timeStamp:Date.now(),isDefaultPrevented:()=>!1,isPropagationStopped:()=>!1}}const{input:V,outerContainer:Fe,horisontalContainer:We,searchIcon:G,clearButton:O}=W,je=e=>{switch(e){case"large":return"medium";case"medium":return"medium";case"small":return"small"}},qe=d(re)`
...
`,Je=d.div`
  position: relative;
  display: flex;
`,se=r.forwardRef(({componentSize:e="medium",buttonProps:l,name:g,label:u,tip:v,id:L,value:a,onChange:m,className:X,style:k,"aria-describedby":h,...x},p)=>{const D=r.useId(),o=L??`${D}-searchInput`,z=!!u,I=M(o,"tip"),y=M(o,"suggestions"),$=M(o,"suggestions-description"),[S,R]=r.useState(!!a),t=De(),H=t.inputRef?pe(t.inputRef,p):p,c=N=>{R(N.target.value!==""),t.onValueChange&&t.onValueChange(N),m&&m(N)},f=()=>{const N=Oe(o);c(N)},B={className:X,style:k},C={...x,ref:H,componentSize:e,name:g,type:"search",id:o,"aria-describedby":Se([v?I:void 0,t.suggestions?$:void 0,h]),value:t.inputValue!==void 0?t.inputValue:a,onChange:c,autoComplete:"off"},{label:T,onClick:E,...n}=l||{},b=!!t.suggestions,q=!!l&&!!E;return w(Qe,{children:[z&&i($e,{htmlFor:o,children:u}),w("div",{children:[w(Ge,{hasSearchButton:q,...B,children:[w(Je,{children:[i(Ye,{icon:be,size:e,iconSize:je(e)}),i(qe,{...C,"aria-autocomplete":b?"list":void 0,"aria-controls":b?y:void 0,"aria-expanded":t.showSuggestions,role:b?"combobox":void 0}),b&&w(ie,{children:[i(j,{id:y,ref:t.suggestionsRef,searchId:o,onSuggestionClick:t.onSugggestionClick,suggestions:t.suggestions,showSuggestions:t.showSuggestions,componentSize:e}),i(Le,{id:$,as:"span",children:"Bla i søkeforslag med piltaster når listen er utvidet."})]}),S&&i(_e,{icon:xe,size:"tiny",purpose:"secondary",appearance:"borderless","aria-label":"Tøm",onClick:f})]}),q&&i(K,{size:e,label:T||"Søk",onClick:E,...n})]}),ve(v,I)]})]})});se.displayName="Search";const te=e=>{const{value:l,data:g,filter:u,queryLength:v=2,onChange:L,onSuggestionSelection:a,children:m}=e,[X,k]=r.useState(l||""),[h,x]=r.useState([]),[p,D]=r.useState(!1),o=()=>p===!0&&D(!1),z=()=>p===!1&&D(!0);r.useEffect(()=>{h.length>0?z():o()},[h]);const I=c=>c.array[0].relevance!==void 0,y=c=>{const f=c.target.value;S(f);let B=[];if(f.length>=v){if(g)if(I(g)){const{sortFunction:C,array:T}=g;B=T.filter(n=>u?u(n.text,f):Y(n.text,f)).sort(C?(n,b)=>C(n,b):void 0).map(n=>n.text)}else{const{sortFunction:C,array:T}=g;B=T.filter(n=>u?u(n,f):Y(n,f)).sort(C?(n,b)=>C(n,b):void 0)}x(B)}else x([]);L&&L(c)},$=c=>{x([]),S(c.target.innerText),a&&a(),o()},S=c=>{k(c||"")},R=r.useRef(null),t=r.useRef(null);me([R.current,t.current],()=>{o()}),he("Tab",()=>o());const H={showSuggestions:p,inputRef:R,suggestionsRef:t,suggestions:h,onValueChange:y,inputValue:X,onSugggestionClick:$};return i(U.Provider,{value:H,children:m})};te.displayName="SearchAutocompleteWrapper";const oe=se;oe.AutocompleteWrapper=te;oe.Suggestions=j;export{oe as S};
//# sourceMappingURL=index-3d57254c.js.map
