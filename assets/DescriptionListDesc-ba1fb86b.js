import{d as b,s as g,A as y,a as D,j as h}from"./ddsReferenceTokens-ceb64027.js";import{r as L}from"./index-1b03fe98.js";import{s as S,g as v}from"./BaseComponentProps-d435d0d0.js";import"./libraryAdd-21442db5.js";import{I as $}from"./Icon-db6dd7fc.js";const{spacing:r,colors:d}=b,x={appearance:{small:{color:d.DdsColorNeutralsGray7},bold:{color:d.DdsColorNeutralsGray9}},firstOfType:{marginTop:r.SizesDdsSpacingLocalX1}},E={base:{gap:r.SizesDdsSpacingLocalX025,color:d.DdsColorNeutralsGray9},lastChild:{marginBottom:r.SizesDdsSpacingLocalX1}},P={beforeNextTerm:{marginTop:r.SizesDdsSpacingLocalX2},rowDirection:{columnGap:r.SizesDdsSpacingLocalX2}},k={base:{margin:r.SizesDdsSpacingLocalX2}},p={term:x,desc:E,list:P,group:k},{term:_,desc:w,list:T}=p,H=g.dl`
  margin: 0;
  *::selection {
    ${S}
  }
...
//# sourceMappingURL=DescriptionListDesc-ba1fb86b.js.map
