import{d as y,s as m,A as f,j as g,a as S}from"./focus-visible-35158c22.js";import{r as D}from"./index-d47b1f5a.js";import{Z as b,a as $}from"./dds-core-29d22035.js";import{z as h}from"./dds-icons-7a922c3a.js";const{spacing:t,colors:d}=y,x={appearance:{small:{color:d.DdsColorNeutralsGray7},bold:{color:d.DdsColorNeutralsGray9}},firstOfType:{marginTop:t.SizesDdsSpacingLocalX1}},N={base:{gap:t.SizesDdsSpacingLocalX025,color:d.DdsColorNeutralsGray9},lastChild:{marginBottom:t.SizesDdsSpacingLocalX1}},w={beforeNextTerm:{marginTop:t.SizesDdsSpacingLocalX2},rowDirection:{columnGap:t.SizesDdsSpacingLocalX2}},z={base:{margin:t.SizesDdsSpacingLocalX2}},p={term:x,desc:N,list:w,group:z},{term:L,desc:X,list:T}=p,C=m.dl`
  margin: 0;
  *::selection {
    ${b}
  }
...
//# sourceMappingURL=DescriptionListDesc-aeb60806.js.map
