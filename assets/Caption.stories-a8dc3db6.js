import{a as e}from"./jsx-runtime-e43ccb36.js";import{C as s}from"./Caption-f392befe.js";import{S as l}from"./StoryTemplate-d3d045d5.js";const c={title:"dds-components/Typography/Caption",component:s,argTypes:{withMargins:{control:{type:"boolean"}},text:{control:{type:"text"}}}},t=n=>{const{text:p,...i}=n;return e(l,{title:"Caption - default",children:e(s,{...i,children:p||"Caption"})})};var o,r,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: StoryTProps) => {
  const {
    text,
    ...rest
  } = args;
...
//# sourceMappingURL=Caption.stories-a8dc3db6.js.map
