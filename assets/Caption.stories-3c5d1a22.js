import{a as e}from"./jsx-runtime-e43ccb36.js";import{C as s}from"./Caption-848a816b.js";import{S as l}from"./StoryTemplate-f03f5b44.js";const c={title:"dds-components/Typography/Caption",component:s,argTypes:{withMargins:{control:{type:"boolean"}},text:{control:{type:"text"}}}},t=n=>{const{text:p,...i}=n;return e(l,{title:"Caption - default",children:e(s,{...i,children:p||"Caption"})})};var o,r,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: StoryTProps) => {
  const {
    text,
    ...rest
  } = args;
...
//# sourceMappingURL=Caption.stories-3c5d1a22.js.map
