import{s as K,A as H,j as a,d as ka,a as t}from"./focus-visible-c2e9b88d.js";import{R as D}from"./storybook-components-c9cbefc3.js";import{r}from"./index-ebeaab24.js";import{g as X}from"./BaseComponentProps-bb0d5515.js";import{s as Y}from"./scrollbarStyling-a46ac0ea.js";import{a as q,f as G}from"./focusVisible-75802ac7.js";import{u as Sa}from"./useRoveFocus-1974dcb0.js";import{u as J}from"./useCombinedRefs-40b11bb4.js";import{u as Ia}from"./useOnKeyDown-4552d984.js";import{u as $a}from"./useOnClickOutside-1aed2959.js";import{d as La,e as Ca}from"./Typography.utils-99dd1e07.js";import{n as wa}from"./normalize-f756ee4b.js";import{r as Da}from"./removeButtonStyling-867d6ba4.js";import{I as Ra}from"./Icon-819df738.js";import{N as v}from"./notifications-f2fc499f.js";const ya=r.createContext({activeTab:0,tabsId:"",handleTabChange:()=>null,tabListRef:null,tabPanelsRef:null,hasTabFocus:!1,setHasTabFocus:()=>null,tabContentDirection:"row"}),Q=()=>r.useContext(ya),xa=K.div`
  ${({width:n})=>n&&H`
      width: ${n};
    `};
`,P=r.forwardRef((n,b)=>{const{id:l,activeTab:s,onChange:d,tabContentDirection:T="row",width:i,children:h,className:c,htmlProps:p,...I}=n,$=r.useId(),R=l??`${$}-tabs`,[L,C]=r.useState(s||0),[A,w]=r.useState(!1),x=r.useRef(null),V=r.useRef(null),N=m=>{C(m),d&&d(m)};r.useEffect(()=>{s!==void 0&&s!==L&&C(s)},[s,L]);const u={...X(R,c,p,I),ref:b};return a(ya.Provider,{value:{tabsId:R,activeTab:L,handleTabChange:N,tabListRef:x,tabPanelsRef:V,hasTabFocus:A,setHasTabFocus:w,tabContentDirection:T},children:a(xa,{...u,width:i,children:h})})});P.displayName="Tabs";const{border:M,spacing:_,colors:k}=ka,Na={borderBottom:`${M.BordersDdsBorderStyleLightStrokeWeight} solid ${M.BordersDdsBorderStyleLightStroke}`},Aa={base:{borderBottom:`${M.BordersDdsBorderStyleLightStrokeWeight} solid transparent`,color:k.DdsColorNeutralsGray7,padding:_.SizesDdsSpacingLocalX05},row:{gap:_.SizesDdsSpacingLocalX05},column:{gap:_.SizesDdsSpacingLocalX025},active:{backgroundColor:k.DdsColorInteractiveLightest,color:k.DdsColorInteractiveDarkest,boxShadow:`inset 0 -2px 0 0 ${k.DdsColorInteractiveDarker}`,borderColor:k.DdsColorInteractiveDarker},hover:{color:k.DdsColorInteractiveDarkest,boxShadow:`inset 0 -2px 0 0 ${k.DdsColorInteractiveDarker}`,borderColor:k.DdsColorInteractiveDarker}},ja={padding:_.SizesDdsSpacingLocalX025},U={tabList:Na,tab:Aa,panel:ja},{tab:f}=U,Ba=K.button`
  ${wa}
  ${Da}
  user-select: text;
  display: flex;
...
`,e=r.forwardRef((n,b)=>{const{active:l=!1,icon:s,children:d,focus:T,setFocus:i,index:h,onClick:c,onKeyDown:p,id:I,className:$,htmlProps:R,...L}=n,C=r.useRef(null),A=J(b,C),{tabPanelsRef:w,setHasTabFocus:x,tabContentDirection:V}=Q();r.useEffect(()=>{var y;T&&((y=C.current)==null||y.focus(),x(!0))},[T]),Ia("Tab",()=>{var y;x(!1),(y=w==null?void 0:w.current)==null||y.focus()});const N=r.useCallback(()=>{i&&h&&i(h)},[h,i]),u=y=>{N(),c&&c(y)},m=y=>{N(),p&&p(y)},va={...X(I,$,R,L),ref:A,"aria-selected":l,role:"tab",active:l,direction:V,onClick:u,onKeyDown:m,tabIndex:T?0:-1};return t(Ba,{...va,children:[s&&a(Ra,{icon:s,iconSize:"inherit"}),a("span",{children:d})]})});e.displayName="Tab";const{tabList:Fa}=U,Oa=K.div`
...
`,g=r.forwardRef(({children:n,id:b,onFocus:l,...s},d)=>{const{activeTab:T,tabsId:i,handleTabChange:h,tabListRef:c,hasTabFocus:p,tabPanelsRef:I,setHasTabFocus:$}=Q(),R=b??`${i}-tablist`,L=r.Children.toArray(n).length,[C,A]=Sa(L,!p,"row"),w=J(d,c),x=r.Children.map(n,(u,m)=>r.isValidElement(u)&&r.cloneElement(u,{id:`${i}-tab-${m}`,"aria-controls":`${i}-panel-${m}`,active:T===m,index:m,focus:C===m&&p,setFocus:A,onClick:()=>h(m)}));Ia("Tab",()=>{var u;$(!1),(u=I==null?void 0:I.current)==null||u.focus()}),$a((c==null?void 0:c.current)||null,()=>{$(!1)});const N={...s,ref:w,role:"tablist","aria-label":"Bruk venste og høyre piltast for å bla",id:R,tabIndex:0,onFocus:u=>{$(!0),l&&l(u)}};return a(Oa,{...N,children:x})});g.displayName="TabList";const{panel:Wa}=U,Ea=K.div`
  padding: ${Wa.padding};
  @media (prefers-reduced-motion: no-preference) {
    transition: ${q};
  }
