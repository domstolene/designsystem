import{j as e}from"./focus-visible-35158c22.js";import{C as s}from"./Caption-75086338.js";import{R as l}from"./storybook-components-cc5979ee.js";const c={title:"dds-components/Typography/Caption",component:s,argTypes:{withMargins:{control:{type:"boolean"}},text:{control:{type:"text"}}}},t=n=>{const{text:p,...i}=n;return e(l,{title:"Caption - default",children:e(s,{...i,children:p||"Caption"})})};var o,r,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: StoryTProps) => {
  const {
    text,
    ...rest
  } = args;
...
//# sourceMappingURL=Caption.stories-3f63612d.js.map
