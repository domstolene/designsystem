import{a as _,j as W}from"./jsx-runtime-e43ccb36.js";import{s as u,d as m,A as q,a as P}from"./ddsReferenceTokens-f9f5a4e4.js";import{r as c}from"./index-1b03fe98.js";const v=u.svg`
...
`,ye=()=>_(te,{children:"*"});function T(...e){return c.useCallback(r=>{e.forEach(n=>{typeof n=="function"?n(r):n&&typeof n=="object"&&(n.current=r)})},e)}try{T.displayName="useCombinedRef",T.__docgenInfo={description:`Kombinerer refs for et element.
Eksempel på bruk:
\`\`\`
