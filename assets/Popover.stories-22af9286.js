import{d as S,s as w,C as Y,b as r,j as t,F as re,a as ne}from"./focus-visible-17f12d09.js";import{R as C}from"./storybook-components-54c9cf1b.js";import{r as a}from"./index-c6dae603.js";import{g as le,u as ie}from"./useMountTransition-ab1b2779.js";import{v as se}from"./visibilityTransition-86c3da85.js";import{c as ae}from"./focusVisible-bd00be70.js";import{u as pe}from"./useFloatPosition-f4d76573.js";import{u as de}from"./useCombinedRefs-764cd8e8.js";import{u as ce}from"./useOnClickOutside-08b83e6f.js";import{g as ue}from"./BaseComponentProps-bb0d5515.js";import{T as g}from"./Typography-ddbe86f6.js";import{C as ve}from"./close-bbf4cbe9.js";import{P as me}from"./Paper-19f1cdc7.js";import{B as p}from"./Button-4fdfc19e.js";import{u as ge}from"./useOnKeyDown-77bae070.js";import{r as fe}from"./removeButtonStyling-867d6ba4.js";function he(e,n,d){const l=a.useRef(null);return a.useEffect(()=>{function h(i){if(i.key!=="Tab"||!e||!l.current||!d)return;const c=le(l),s=c[c.length-1],k=c[0];(!i.shiftKey&&document.activeElement===s||i.shiftKey&&document.activeElement===k||i.shiftKey&&document.activeElement===o)&&(d.focus(),i.preventDefault(),n())}const o=l.current;return o&&e&&(o.focus(),o.addEventListener("keydown",h)),()=>{o==null||o.removeEventListener("keydown",h)}},[e]),l}const{spacing:m}=S,ke={padding:`${m.SizesDdsSpacingLocalX075} ${m.SizesDdsSpacingLocalX1} ${m.SizesDdsSpacingLocalX15} ${m.SizesDdsSpacingLocalX1}`},ye={top:m.SizesDdsSpacingLocalX025,right:m.SizesDdsSpacingLocalX025},Pe={marginRight:m.SizesDdsSpacingLocalX2},be={noTitle:{marginTop:m.SizesDdsSpacingLocalX2}},xe={content:be,wrapper:ke,closeButton:ye,title:Pe},{spacing:Te}=S,{wrapper:De,content:Se,closeButton:K,title:we}=xe,Ce=w(me)`
  opacity: 0;
...
`,Ee=w(p)`
  ...
  top: ${K.top};
  right: ${K.right};
`,u=a.forwardRef((e,n)=>{const{title:d,isOpen:l=!1,withCloseButton:h=!0,onBlur:o,onCloseButtonClick:i,onClose:c,anchorElement:s,children:k,placement:E="bottom",offset:y=Te.SizesDdsSpacingLocalX05NumberPx,id:O,className:G,htmlProps:B={},...v}=e,$=he(l,()=>{c&&c(),o&&o()},s&&s),{reference:R,floating:Z,styles:ee}=pe(null,{placement:E,offset:y}),te=de(n,$,Z);a.useEffect(()=>{R(s||null)},[s]);const j=[$.current];s&&j.push(s),ce(j,()=>{l&&c&&c()});const M=ie(l,400),oe={...ue(O,G,B,v),ref:te,isOpen:l,hasTransitionedIn:M,tabIndex:-1,style:{...B.style,...ee.floating},role:"dialog"};return l||M?r(Ce,{...oe,elevation:3,border:"light",children:[d&&t(Be,{children:typeof d=="string"?t(g,{typographyType:"headingSans02",children:d}):d}),t($e,{hasTitle:!!d,withCloseButton:h,children:k}),h&&t(Ee,{icon:ve,appearance:"borderless",purpose:"secondary",size:"small",onClick:i,"aria-label":"Lukk"})]}):null});u.displayName="Popover";const f=({isOpen:e=!1,onCloseButtonClick:n,onTriggerClick:d,children:l,popoverId:h})=>{const[o,i]=a.useState(e),c=a.useId(),s=h??`${c}-popover`,k=()=>{i(!1),n&&n()},E=()=>{i(!o),d&&d()},y=a.useRef(null),O=a.useRef(null);ge(["Esc","Escape"],()=>{var v;o&&(i(!1),(v=y.current)==null||v.focus())});const G=()=>i(!1),B=a.Children.map(l,(v,$)=>a.isValidElement(v)&&($===0?a.cloneElement(v,{"aria-haspopup":"dialog","aria-controls":s,"aria-expanded":o,onClick:E,ref:y}):a.cloneElement(v,{isOpen:o,"aria-hidden":!o,id:s,onCloseButtonClick:k,anchorElement:y.current,ref:O,onClose:G})));return t(re,{children:B})};f.displayName="PopoverGroup";const Oe={title:"dds-components/Popover",component:u,argTypes:{withCloseButton:{control:{type:"boolean"}},placement:{control:{type:"text"}},title:{control:{type:"text"}},offset:{control:{type:"number"}}},parameters:{controls:{exclude:["onCloseButton","anchorElement"]}}},P=e=>r(C,{title:"Popover - content overview",display:"grid",children:[t("div",{children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{...e,title:"Tittel",children:r("div",{style:{display:"flex",flexDirection:"column",paddingTop:"16px"},children:[t(g,{withMargins:!0,children:"Dette er en popover med tittel, innhold og lukkeknapp"}),t(p,{label:"Klikk"})]})})]})}),t("div",{children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{...e,title:"Tittel",withCloseButton:!1,children:r("div",{style:{display:"flex",flexDirection:"column"},children:[t(g,{withMargins:!0,children:"Dette er en popover med tittel og innhold"}),t(p,{label:"Klikk"})]})})]})}),t("div",{children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{...e,children:r("div",{style:{display:"flex",flexDirection:"column"},children:[t(g,{withMargins:!0,children:"Dette er en popover med innhold og lukkeknapp"}),t(p,{label:"Klikk"})]})})]})})]}),b=()=>{const e=n=>t("div",{children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{placement:n,children:n})]})});return r(C,{title:"Popover - placement overview",display:"grid",columnsAmount:4,containerStyle:{alignContent:"center",justifyContent:"center",padding:"150px 40px 200px 40px"},children:[e("top-start"),e("bottom-start"),e("left-start"),e("right-start"),e("top"),e("bottom"),e("right"),e("left"),e("top-end"),e("bottom-end"),e("right-end"),e("left-end")]})},x=e=>t(C,{title:"Popover - default",display:"block",children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{...e,children:r("div",{style:{display:"flex",flexDirection:"column"},children:[t(g,{withMargins:!0,children:"Dette er en popover med tekst og knapp"}),t(p,{label:"Klikk"})]})})]})}),T=e=>t(C,{title:"Popover - overflow",display:"block",children:r(f,{children:[t(p,{label:"Åpne"}),t(u,{...e,sizeProps:{maxWidth:"150px",maxHeight:"200px"},children:r("div",{style:{display:"flex",flexDirection:"column"},children:[t(g,{withMargins:!0,style:{textOverflow:"ellipsis",overflow:"hidden",whiteSpace:"nowrap"},children:"Dette er en popover med tekst og knapp"}),t(p,{label:"Klikk"})]})})]})}),D=e=>{const n=w.button`
    ${fe}
    user-select: text;
...
}`,...(N=(F=b.parameters)==null?void 0:F.docs)==null?void 0:N.source}}};var _,V,H;x.parameters={...x.parameters,docs:{...(_=x.parameters)==null?void 0:_.docs,source:{originalSource:`(args: PopoverProps) => {
...
}`,...(H=(V=x.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var W,A,q;T.parameters={...T.parameters,docs:{...(W=T.parameters)==null?void 0:W.docs,source:{originalSource:`(args: PopoverProps) => {
...
}`,...(q=(A=T.parameters)==null?void 0:A.docs)==null?void 0:q.source}}};var J,Q,U;D.parameters={...D.parameters,docs:{...(J=D.parameters)==null?void 0:J.docs,source:{originalSource:`(args: PopoverProps) => {
...
//# sourceMappingURL=Popover.stories-22af9286.js.map
