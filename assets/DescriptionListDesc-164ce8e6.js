import{a as g,j as b}from"./jsx-runtime-e43ccb36.js";import{r as D}from"./index-1b03fe98.js";import{d as h,s as L,A as y}from"./ddsReferenceTokens-baf3ad90.js";import{s as S,g as v}from"./BaseComponentProps-46424d28.js";import"./libraryAdd-ba36db88.js";import{I as $}from"./Icon-169fc8ae.js";const{spacing:r,colors:d}=h,x={appearance:{small:{color:d.DdsColorNeutralsGray7},bold:{color:d.DdsColorNeutralsGray9}},firstOfType:{marginTop:r.SizesDdsSpacingLocalX1}},E={base:{gap:r.SizesDdsSpacingLocalX025,color:d.DdsColorNeutralsGray9},lastChild:{marginBottom:r.SizesDdsSpacingLocalX1}},P={beforeNextTerm:{marginTop:r.SizesDdsSpacingLocalX2},rowDirection:{columnGap:r.SizesDdsSpacingLocalX2}},k={base:{margin:r.SizesDdsSpacingLocalX2}},p={term:x,desc:E,list:P,group:k},{term:_,desc:w,list:T}=p,H=L.dl`
  margin: 0;
  *::selection {
    ${S}
  }
...
//# sourceMappingURL=DescriptionListDesc-164ce8e6.js.map
