import{j as r,a as t,F as oe}from"./jsx-runtime-e43ccb36.js";import{S as w}from"./StoryTemplate-b1805fe5.js";import"./Caption-7324954d.js";import"./Heading-a143a4ab.js";import"./Label-e6c412e2.js";import"./Legend-8686145c.js";import"./Link-0af95a08.js";import"./Paragraph-67d8f149.js";import"./TextOverflowEllipsis-5f7b5b23.js";import{T as g}from"./Typography-37e894bc.js";import{d as S,s as C,n as Y,a as re}from"./ddsReferenceTokens-cf345c8b.js";import{o as ne,v as ie,b as le,e as ae,l as se,g as pe,P as de,f as ue}from"./BaseComponentProps-217bcb03.js";import{r as ce}from"./removeButtonStyling-867d6ba4.js";import{r as s}from"./index-1b03fe98.js";import{u as me}from"./useFloatPosition-8239dfed.js";import{C as ve}from"./libraryAdd-792d55f1.js";import"./Icon-96508a26.js";import{f as fe}from"./Input.styles-9955857c.js";import{B as p}from"./Button-8ec36c15.js";function ge(e,n,d){const i=s.useRef(null);return s.useEffect(()=>{function h(l){if(l.key!=="Tab"||!e||!i.current||!d)return;const c=ne(i),a=c[c.length-1],k=c[0];(!l.shiftKey&&document.activeElement===a||l.shiftKey&&document.activeElement===k||l.shiftKey&&document.activeElement===o)&&(d.focus(),l.preventDefault(),n())}const o=i.current;return o&&e&&(o.focus(),o.addEventListener("keydown",h)),()=>{o==null||o.removeEventListener("keydown",h)}},[e]),i}const{spacing:f}=S,he={padding:`${f.SizesDdsSpacingLocalX075} ${f.SizesDdsSpacingLocalX1} ${f.SizesDdsSpacingLocalX15} ${f.SizesDdsSpacingLocalX1}`},ke={top:f.SizesDdsSpacingLocalX025,right:f.SizesDdsSpacingLocalX025},ye={marginRight:f.SizesDdsSpacingLocalX2},Pe={noTitle:{marginTop:f.SizesDdsSpacingLocalX2}},xe={content:Pe,wrapper:he,closeButton:ke,title:ye},{spacing:Te}=S,{wrapper:Be,content:be,closeButton:M,title:Se}=xe,we=C(de)`
  opacity: 0;
...
//# sourceMappingURL=Popover.stories-9c4af9ad.js.map
