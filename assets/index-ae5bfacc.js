...
`,B=l.forwardRef(({density:e="normal",children:o,...r},n)=>{const s={ref:n,density:e,...r};return t(Re,{...s,children:o})});B.displayName="Table";const V=l.createContext({headerValues:[],definingColumnIndex:[0]}),Te=()=>l.useContext(V),ze=p(B)`
  ...
  ${({withDividers:e})=>e&&a`
    ...
    `}
`,j=l.forwardRef((e,o)=>{const{density:r="normal",children:n,isCollapsed:s,headerValues:d,definingColumnIndex:i=[0],...h}=e,c={ref:o,density:r,isCollapsed:s,...h};return t(V.Provider,{value:{isCollapsed:s,headerValues:d,definingColumnIndex:i},children:t(ze,{...c,children:n})})});j.displayName="CollapsibleTable";const Le=p.thead``,H=l.forwardRef(({children:e,...o},r)=>{const n={...o};return t(Le,{ref:r,...n,children:e})});H.displayName="Table.Head";const Be=p.tbody``,G=l.forwardRef(({children:e,...o},r)=>{const n={...o};return t(Be,{ref:r,...n,children:e})});G.displayName="Table.Body";const Ne=p.tfoot``,M=l.forwardRef(({children:e,...o},r)=>{const n={...o};return t(Ne,{ref:r,...n,children:e})});M.displayName="Table.Foot";const{row:$}=k,E=(e,o)=>a`
    ${e==="sum"&&a`
      font-weight: 600;
  ...
  ${({type:e,mode:o,selected:r,hoverable:n})=>e==="body"&&a`
    ...
    `}
`,Q=l.forwardRef(({type:e="body",mode:o="normal",children:r,...n},s)=>{const d={type:e,mode:o,...n};return t(x,{ref:s,...d,children:r})});Q.displayName="Table.Row";const{cell:U}=k,We=e=>{switch(e){case"center":return a`
