import{j as r,a as t,F as oe}from"./jsx-runtime-e43ccb36.js";import{S as w}from"./StoryTemplate-f63f16be.js";import"./Caption-c95a25e6.js";import"./Heading-eb094a5f.js";import"./Label-7698c3d3.js";import"./Legend-90ca2ccd.js";import"./Link-a0d6f9b6.js";import"./Paragraph-74ee9681.js";import"./TextOverflowEllipsis-a0e35774.js";import{T as g}from"./Typography-8df5b43e.js";import{d as S,s as C,n as Y,a as re}from"./ddsReferenceTokens-cf345c8b.js";import{o as ne,v as ie,b as le,e as ae,l as se,g as pe,P as de,f as ue}from"./BaseComponentProps-c04e3b0f.js";import{r as ce}from"./removeButtonStyling-867d6ba4.js";import{r as s}from"./index-1b03fe98.js";import{u as me}from"./useFloatPosition-8239dfed.js";import{C as ve}from"./libraryAdd-bb03a5d3.js";import"./Icon-feef9230.js";import{f as fe}from"./Input.styles-cd9d8463.js";import{B as p}from"./Button-db658d75.js";function ge(e,n,d){const i=s.useRef(null);return s.useEffect(()=>{function h(l){if(l.key!=="Tab"||!e||!i.current||!d)return;const c=ne(i),a=c[c.length-1],k=c[0];(!l.shiftKey&&document.activeElement===a||l.shiftKey&&document.activeElement===k||l.shiftKey&&document.activeElement===o)&&(d.focus(),l.preventDefault(),n())}const o=i.current;return o&&e&&(o.focus(),o.addEventListener("keydown",h)),()=>{o==null||o.removeEventListener("keydown",h)}},[e]),i}const{spacing:f}=S,he={padding:`${f.SizesDdsSpacingLocalX075} ${f.SizesDdsSpacingLocalX1} ${f.SizesDdsSpacingLocalX15} ${f.SizesDdsSpacingLocalX1}`},ke={top:f.SizesDdsSpacingLocalX025,right:f.SizesDdsSpacingLocalX025},ye={marginRight:f.SizesDdsSpacingLocalX2},Pe={noTitle:{marginTop:f.SizesDdsSpacingLocalX2}},xe={content:Pe,wrapper:he,closeButton:ke,title:ye},{spacing:Te}=S,{wrapper:Be,content:be,closeButton:M,title:Se}=xe,we=C(de)`
  opacity: 0;
...
//# sourceMappingURL=Popover.stories-211c6403.js.map
