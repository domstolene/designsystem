...
specified depth.
@param depth The maximum recursion depth`,name:"flat",required:!0,type:{name:"<A, D extends number = 1>(this: A, depth?: D | undefined) => FlatArray<A, D>[]"}},"__@iterator@428":{defaultValue:null,description:"Iterator",name:"__@iterator@428",required:!0,type:{name:"() => IterableIterator<Ref<T>>"}},"__@unscopables@1438":{defaultValue:null,description:`Is an object whose properties have the value 'true'
...
specified depth.
@param depth The maximum recursion depth`,name:"flat",required:!0,type:{name:"<A, D extends number = 1>(this: A, depth?: D | undefined) => FlatArray<A, D>[]"}},"__@iterator@428":{defaultValue:null,description:"Iterator",name:"__@iterator@428",required:!0,type:{name:"() => IterableIterator<string | undefined>"}},"__@unscopables@1438":{defaultValue:null,description:`Is an object whose properties have the value 'true'
when they will be absent when used in a 'with' statement.`,name:"__@unscopables@1438",required:!0,type:{name:"{ [x: number]: boolean | undefined; length?: boolean | undefined; toString?: boolean | undefined; toLocaleString?: boolean | undefined; pop?: boolean | undefined; push?: boolean | undefined; ... 29 more ...; at?: boolean | undefined; }"}},at:{defaultValue:null,description:`Takes an integer value and returns the item at that index,
allowing for positive and negative integers.
...
@param regexp A variable name or string literal containing the regular expression pattern and flags.`,name:"matchAll",required:!0,type:{name:"(regexp: RegExp) => IterableIterator<RegExpMatchArray>"}},"__@iterator@428":{defaultValue:null,description:"Iterator",name:"__@iterator@428",required:!0,type:{name:"() => IterableIterator<string>"}},at:{defaultValue:null,description:`Takes an integer value and returns the item at that index,
allowing for positive and negative integers.
...
//# sourceMappingURL=BaseComponentProps-77dc9c6e.js.map
