import{d as q,b as be,s as m,A as $,j as e,a as n}from"./focus-visible-35158c22.js";import{r as a}from"./index-d47b1f5a.js";import{R as B}from"./storybook-components-cc5979ee.js";import{O as J,E as De,T as i}from"./dds-typography-e761338c.js";import{Z as Se,a as R,C as Ae,L as xe,v as Le,K as $e}from"./dds-core-29d22035.js";import{j as Be,G as Ee}from"./dds-form-b2eacd8d.js";import{a as Q,b as Y,D as ee}from"./DescriptionListDesc-aeb60806.js";import{D as we}from"./Divider-982ab6b7.js";const{colors:A,border:K}=q,{textDefault:G}=be,He={border:`${K.BordersDdsBorderStyleLightStrokeWeight} solid`},Ie={filledLight:{backgroundColor:A.DdsColorPrimaryLightest,borderColor:A.DdsColorPrimaryLightest,color:G.textColor},filledDark:{backgroundColor:A.DdsColorPrimaryBase,borderColor:A.DdsColorPrimaryBase,color:A.DdsColorNeutralsWhite},strokeDark:{backgroundColor:A.DdsColorNeutralsWhite,borderColor:K.BordersDdsBorderStyleLightStroke,color:G.textColor},strokeLight:{backgroundColor:A.DdsColorNeutralsWhite,borderColor:K.BordersDdsBorderStyleLightStroke,color:G.textColor}},N={base:He,colors:Ie},re=m.div`
  ...
  *::selection {
  ...
  ${({cardType:r})=>r==="navigation"?$`
        ...
        `:""}
`,o=r=>{const{color:t="filledLight",cardType:s,cardRef:d,children:h,id:f,className:u,htmlProps:k,...T}=r;if(s==="navigation"){const{href:y,target:v}=r;return e(re,{...R(f,u,k,T),cardType:s,color:t,as:"a",ref:d,href:y,target:v,children:h})}return e(re,{...R(f,u,k,T),cardType:s,color:t,as:"div",ref:d,children:h})};o.displayName="Card";const Pe=m.div``,l=a.forwardRef((r,t)=>{const{isExpanded:s=!1,onChange:d,id:h,children:f,className:u,htmlProps:k,...T}=r,[y,v]=a.useState(s),b=a.useId(),S=h??`${b}-cardAccordion`;a.useEffect(()=>{v(s)},[s]);const E=a.useCallback(()=>{const D=!y;v(D),d&&d(D)},[y,d]),x=a.Children.map(f,(D,M)=>{const W=`${S}-header`,_=`${S}-body`;return a.isValidElement(D)&&(M===0?a.cloneElement(D,{isExpanded:y,toggleExpanded:E,id:W,bodyId:_}):a.cloneElement(D,{isExpanded:y,id:_,headerId:W}))}),w={...R(h,u,k,T),ref:t};return e(Pe,{...w,children:x})});l.displayName="CardAccordion";const{spacing:c,border:F,iconSizes:Z}=q,ve={body:"bodySans03",header:"headingSans03"},ze={padding:`${c.SizesDdsSpacingLocalX1} ${c.SizesDdsSpacingLocalX075} ${c.SizesDdsSpacingLocalX1} ${c.SizesDdsSpacingLocalX15}`,hover:{boxShadow:`0 0 0 ${F.BordersDdsBorderFocusInputfieldStrokeWeight} ${F.BordersDdsBorderFocusInputfieldStroke}`},focus:{boxShadow:`0 0 0 ${F.BordersDdsBorderFocusCardStrokeWeight} ${F.BordersDdsBorderFocusCardStroke}`}},je={width:Z.DdsIconsizeMedium,height:Z.DdsIconsizeMedium,marginLeft:c.SizesDdsSpacingLocalX05},Oe={padding:`${c.SizesDdsSpacingLocalX1} ${c.SizesDdsSpacingLocalX2NumberPx+c.SizesDdsSpacingLocalX075NumberPx}px ${c.SizesDdsSpacingLocalX2} ${c.SizesDdsSpacingLocalX15}`},X={header:ze,body:Oe,chevronWrapper:je,chevron:{width:Z.DdsIconsizeMedium,height:c.SizesDdsSpacingLocalX05}},{header:U,chevronWrapper:V}=X,Re=m.div`
  text-align: left;
`;function We(r){const{padding:t}=r;return t||U.padding}function Ne(r){const{typographyType:t}=r;return t||ve.header}const Fe=m.div`
  display: flex;
...
`,p=a.forwardRef((r,t)=>{const{children:s,isExpanded:d=!1,toggleExpanded:h,bodyId:f,id:u,className:k,htmlProps:T,padding:y,typographyType:v,bold:b,...S}=r,E=()=>{h&&h()},x={...R(u,k,T,S),"aria-expanded":d,"aria-controls":f,ref:t,onClick:E},w={isUp:d,width:X.chevron.width,height:X.chevron.height};return e(Xe,{...x,type:"button",children:n(Fe,{typographyType:v,padding:y,bold:b,children:[e(Re,{children:s}),e(Me,{children:e(Le,{...w})})]})})});p.displayName="CardAccordionHeader";function _e(r){const[t,s]=a.useState(null);return a.useEffect(()=>{if(!r)return;const d=new ResizeObserver(()=>{s(r.offsetHeight)});return d.observe(r),()=>d.disconnect()},[r]),t}const Ge=$`
  @media (prefers-reduced-motion: no-preference) {
    transition: height 0.2s cubic-bezier(0.4, 0, 0.2, 1);
  }
`;function Ve(r){const{padding:t}=r;return t||X.body.padding}const Ke=m.div`
  @media (prefers-reduced-motion: no-preference) {
    ${({animate:r})=>r&&Ge}
  }
  ${J(ve.body)}
...
}`,...(ae=(te=H.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var de,ie,se;I.parameters={...I.parameters,docs:{...(de=I.parameters)==null?void 0:de.docs,source:{originalSource:`(args: CardProps) => {
...
}`,...(fe=(me=j.parameters)==null?void 0:me.docs)==null?void 0:fe.source}}};var ue,ke,Te;O.parameters={...O.parameters,docs:{...(ue=O.parameters)==null?void 0:ue.docs,source:{originalSource:`(args: CardProps) => {
...
}`,...(Te=(ke=O.parameters)==null?void 0:ke.docs)==null?void 0:Te.source}}};const qe=["Overview","Default","Accordion","AccordionControlled","AccordionCustom","Examples"],ar=Object.freeze(Object.defineProperty({__proto__:null,Accordion:P,AccordionControlled:z,AccordionCustom:j,Default:I,Examples:O,Overview:H,__namedExportsOrder:qe,default:Ue},Symbol.toStringTag,{value:"Module"}));export{ar as C,I as D,l as a,g as b};
//# sourceMappingURL=Card.stories-ea879c32.js.map
