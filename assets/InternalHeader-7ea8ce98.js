...
`;try{_.displayName="OuterContainer",_.__docgenInfo={description:"",displayName:"OuterContainer",props:{}}}catch{}try{k.displayName="BannerWrapper",k.__docgenInfo={description:"",displayName:"BannerWrapper",props:{hasContextMenu:{defaultValue:null,description:"",name:"hasContextMenu",required:!1,type:{name:"boolean | undefined"}}}}}catch{}try{h.displayName="BannerLeftWrapper",h.__docgenInfo={description:"",displayName:"BannerLeftWrapper",props:{}}}catch{}try{b.displayName="ApplicationNameWrapper",b.__docgenInfo={description:"",displayName:"ApplicationNameWrapper",props:{}}}catch{}try{C.displayName="LovisaWrapper",C.__docgenInfo={description:"",displayName:"LovisaWrapper",props:{}}}catch{}try{N.displayName="Navigation",N.__docgenInfo={description:"",displayName:"Navigation",props:{}}}catch{}try{L.displayName="NavigationList",L.__docgenInfo={description:"",displayName:"NavigationList",props:{smallScreen:{defaultValue:null,description:"Indikerer om versjonen for små skjermer skal vises.",name:"smallScreen",required:!1,type:{name:"boolean | undefined"}}}}}catch{}try{S.displayName="ContextMenuGroup",S.__docgenInfo={description:"",displayName:"ContextMenuGroup",props:{}}}catch{}try{I.displayName="StyledOverflowMenu",I.__docgenInfo={description:"",displayName:"StyledOverflowMenu",props:{htmlProps:{defaultValue:null,description:"Ekstra HTML-attributter som vil settes på elementet som genereres. Untatt `id` og `className` som settes på toppnivå.",name:"htmlProps",required:!1,type:{name:"HTMLAttributes<HTMLDivElement> | undefined"}},onClose:{defaultValue:null,description:"Callback for å lukke menyen. **OBS!** nødvendig kun hvis `<OverflowMenuGroup />` ikke brukes.",name:"onClose",required:!1,type:{name:"(() => void) | undefined"}},placement:{defaultValue:null,description:"Plassering av menyen i forhold til anchor-elementet.",name:"placement",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"left"'},{value:'"right"'},{value:'"bottom"'},{value:'"top"'},{value:'"top-start"'},{value:'"top-end"'},{value:'"bottom-start"'},{value:'"bottom-end"'},{value:'"right-start"'},{value:'"right-end"'},{value:'"left-start"'},{value:'"left-end"'}]}},userProps:{defaultValue:null,description:"Eget element for brukernavn, kan være interaktivt eller statisk. Ligger alltid på toppen av menyen.",name:"userProps",required:!1,type:{name:"UserProps | undefined"}},offset:{defaultValue:null,description:"Avstand fra anchor-elementet i px.",name:"offset",required:!1,type:{name:"number | undefined"}},isOpen:{defaultValue:null,description:"Spesifiserer om menyen skal vises. **OBS!** nødvendig kun hvis `<OverflowMenuGroup />` ikke brukes.",name:"isOpen",required:!1,type:{name:"boolean | undefined"}},onToggle:{defaultValue:null,description:"Callback for å toggle menyen. **OBS!** nødvendig kun hvis `<OverflowMenuGroup />` ikke brukes.",name:"onToggle",required:!1,type:{name:"(() => void) | undefined"}},items:{defaultValue:null,description:"Lenker eller knapper som skal vises i menyen. Støtter ikon i tillegg til tekst.",name:"items",required:!1,type:{name:"OverflowMenuContextItem[] | undefined"}},navItems:{defaultValue:null,description:"Navigasjonslenker, brukes hvis navigasjonen skal ligge i menyen (f.eks. ved liten skjerm o.l.).",name:"navItems",required:!1,type:{name:"OverflowMenuLinkItem[] | undefined"}},anchorRef:{defaultValue:null,description:"Ref til elementet som styrer menyen. **OBS!** nødvendig kun hvis ``<OverflowMenuGroup />` ikke brukes.",name:"anchorRef",required:!1,type:{name:"RefObject<HTMLButtonElement> | undefined"}}}}}catch{}const{navLink:a}=G,x=r.a`
  display: flex;
  align-items: center;
  height: 100%;
  box-sizing: border-box;
...
//# sourceMappingURL=InternalHeader-7ea8ce98.js.map
