import{d as y,s as m,A as f,a as g,j as S}from"./ddsReferenceTokens-f1d35829.js";import{r as D}from"./index-d47b1f5a.js";import{Q as b,a as $}from"./dds-core-c67132cd.js";import{i as h}from"./dds-icons-265d9665.js";const{spacing:t,colors:d}=y,x={appearance:{small:{color:d.DdsColorNeutralsGray7},bold:{color:d.DdsColorNeutralsGray9}},firstOfType:{marginTop:t.SizesDdsSpacingLocalX1}},N={base:{gap:t.SizesDdsSpacingLocalX025,color:d.DdsColorNeutralsGray9},lastChild:{marginBottom:t.SizesDdsSpacingLocalX1}},w={beforeNextTerm:{marginTop:t.SizesDdsSpacingLocalX2},rowDirection:{columnGap:t.SizesDdsSpacingLocalX2}},z={base:{margin:t.SizesDdsSpacingLocalX2}},p={term:x,desc:N,list:w,group:z},{term:L,desc:X,list:T}=p,C=m.dl`
  margin: 0;
  *::selection {
    ${b}
  }
...
//# sourceMappingURL=DescriptionListDesc-559bec8b.js.map
