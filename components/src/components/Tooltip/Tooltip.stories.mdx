...
Se stories med kontrollere i <Typography externalLink typographyType="a" href={`${SB_DESIGNSYSTEM_URL}-tooltip`}>Storybook</Typography>.
...
<Source code={`const onFocus = () => { ... } // noe logikk
