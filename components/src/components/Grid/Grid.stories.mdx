...
<Meta title="Design system/Grid/API" component={Grid} />

# Grid

<ComponentLinkRow
  docsHref=""
  githubHref="https://github.com/domstolene/designsystem/tree/master/components/src/components/Grid"
/>

## Demo

<Canvas>
  <Story id="design-system-grid--page-example" />
</Canvas>

<LinkToInteractiveStory href={`${SB_DESIGNSYSTEM_URL}-grid`} />
...
- `<Grid>` - en container-komponent for grid children som tar i bruk CSS Grid og definerer antall kolonner og gaps basert på skjermstørrelse.
