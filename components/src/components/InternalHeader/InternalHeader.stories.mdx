...
<Canvas>
  <Story id="design-system-internalheader--default" />
</Canvas>
<Canvas>
  <Story
    id="design-system-internalheader--with-navigation-and-context-menu"
    height="350px"
  />
</Canvas>
<Canvas>
  <Story
    id="design-system-internalheader--small-screen-with-navigation-and-context-menu"
    height="650px"
  />
</Canvas>

<LinkToInteractiveStory href={`${SB_DESIGNSYSTEM_URL}-internalheader`} />
...
applikasjoner vil være tilgjengelige ved å trykke på det som i dag er
logo/navn på applikasjonen.
...
### Før Lovisa Next kommer

Komponenten skal ha logoen til Lovisa Next i venstre hjørne når den er klar. Dette er nåværelnde plasseringen til `logo`-prop. Fram til da skal applikasjonsnavnet settes som `logo` og eventuelt navnet til en underside kan settes i `applicationName`.

<Canvas>
  <Story id="design-system-internalheader--before-lovisa-next" />
</Canvas>
