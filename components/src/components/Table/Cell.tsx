import { ElementType, forwardRef, ThHTMLAttributes, TdHTMLAttributes } from 'react';
...
export const Cell = forwardRef<HTMLTableDataCellElement | HTMLTableHeaderCellElement, TableCellProps>(
