...
<ComponentLinkRow
  docsHref="63b46e-cookiebanner"
  figmaHref="node-id=24188-38408"
  githubHref={{ folder: 'components', comp: 'CookieBanner' }}
  storybookHref={{ folder: 'components', comp: 'cookiebanner' }}
/>
