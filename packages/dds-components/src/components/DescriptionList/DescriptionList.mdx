...
<ComponentLinkRow
  docsHref="46584e-descriptionlist"
  figmaHref="node-id=3332%3A94241"
  githubHref={{ folder: 'components', comp: 'DescriptionList' }}
  storybookHref={{ folder: 'components', comp: 'descriptionlist' }}
/>
