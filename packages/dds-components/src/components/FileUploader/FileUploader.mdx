...
Når filene lastes opp med API vil vi gjerne vise status (laster opp, suksess, feil) og eventuell feilmelding internt i fillisten. Bruk props `fileStatusMap` og `deriveId` til å identifisere filer og oppdatere deres statusinfo.
...
<Canvas of={FileUploaderStories.MockedUpload} />
