...
<Tabs>
  ...
  <TabPanels>
    ...
    <TabPanel>
      ...
      - Automatisk forplanting av enkelte props hos barna: referanse til anchor-elementet og aria-attributter for universell utforming.
...
<Source
  code={`
  import { Popover, PopoverGroup, Button } from '@norges-domstoler/dds-components';

const [isOpen, setIsOpen] = useState(false);

<PopoverGroup isOpen={isOpen} setIsOpen={setIsOpen}>
  <Button>Åpne</Button>
  <Popover>Dette er en popover</Popover>
</PopoverGroup>
`} />
