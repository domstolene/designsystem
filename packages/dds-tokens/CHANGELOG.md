...
- 68f6585: Design tokens som har verdi 0 (f.eks. `0em`) returnerer nå kun `0` uten måleenhet. I TS-format betyr det i tillegg at typen byttes fra `string` til `number`. Følgende tokens er påvirket og blir `0`:
