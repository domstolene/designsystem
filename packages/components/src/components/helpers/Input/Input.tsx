...
import { type InputSize, type StyledInputProps } from './Input.types';
...
type InputTypographyTypes = { [k in InputSize]: StaticTypographyType };
...
type StatefulInputProps = StyledInputProps &
  InputHTMLAttributes<HTMLInputElement>;
