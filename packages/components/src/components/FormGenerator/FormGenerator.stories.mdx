...
<Meta title="Design system/FormGenerator DEPRECATED/API" component={FormGenerator} />

# FormGenerator DEPRECATED
...
<Canvas>
  <Story id="design-system-formgenerator-deprecated--default" />
</Canvas>
