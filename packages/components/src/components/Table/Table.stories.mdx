...
<Canvas>
  <Story id="design-system-table-table--default" />
</Canvas>
<Canvas>
  <Story id="design-system-table-collapsibletable-beta--single-defining-column" />
</Canvas>
<Canvas>
  <Story id="design-system-table-collapsibletable-beta--multiple-defining-columns" />
</Canvas>
...
<ArgsTable of={CollapsibleTable.Row} />
